...
- Frozen M2 Today contract (historical operational reference omitted) and
  M3 lifecycle contract (historical operational reference omitted).
- Existing M2 (historical operational reference omitted) and
  M3 (historical operational reference omitted) platform-evaluation conventions.
- Current recurring Job Tracker policy (historical operational reference omitted),
  bounded scan resumption contract (historical operational reference omitted) and
  platform block report (historical operational reference omitted).
...
- “Move the ExampleCorp application to interviewing.”
