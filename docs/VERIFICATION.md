...
This policy keeps verification proportional to change impact while retaining all CI,
release, identity and domain-admission gates. Successful evidence can be reused
only while its source, dependencies and relevant inputs remain unchanged.
