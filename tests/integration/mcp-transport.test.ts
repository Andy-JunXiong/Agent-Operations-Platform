  ...
  it("discovers and invokes frozen Spike/M1 tools plus Slice M2 locally", async () => {
    ...
    try {
      ...
      expect(tools.tools.map((tool) => tool.name).sort()).toEqual([
        ...
        "workspace_get_skill_library",
        "workspace_record_skill_library",
        "workspace_record_skill_source",
        "workspace_refresh_github_project",
        "workspace_get_candidate_screening",
        ...
        "workspace_get_interview_preparation",
        "workspace_record_interview_preparation",
