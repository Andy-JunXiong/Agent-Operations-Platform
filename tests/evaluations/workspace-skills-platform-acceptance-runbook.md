...
S0–S2 assessment (historical operational reference omitted).
...
Workspace Skills Synthetic Contract Acceptance — 2026-09-08 (historical operational reference omitted).
