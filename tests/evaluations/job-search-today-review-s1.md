...
| N4 | Move the ExampleCorp application to interviewing. | do not route; lifecycle procedure |
...
| A2 | Check ExampleCorp. | resolve intent; named-application review belongs to S2 |
