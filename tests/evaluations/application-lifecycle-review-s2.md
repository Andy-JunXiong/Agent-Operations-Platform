...
|---|---|---|
| P1 | Check the ExampleCorp Data Analytics & AI Manager application. | read-only |
...
| P5 | 看看 ExampleCorp 这个申请现在是什么状态。 | read-only |
...
| N6 | Rewrite my resume for ExampleCorp. | resume workflow, not this Skill |

### Ambiguous

| ID | Prompt | Expected |
|---|---|---|
| A1 | Check ExampleCorp. | clarify company/role or request exact Project ID |
...
See the synthetic acceptance record (historical operational reference omitted).
